/* userns_child_exec.c
    ...
    for Washington University's CSE 522S course on January 23, 2021,
    from the original listing at https://lwn.net/Articles/539940/
    posted February 27, 2013 by mkerrisk

    The code has been modified with additional comments,
    and with the addition of functionality to write "deny"
    to the /proc/PID/setgroups file before writing to gid_map
...
/* Writes "deny" into the /proc/PID/setgroups file;
   this is necessary to allow writing to the gid_map file.
   See, for explanation,
